...
3. Stage 1 — Audio ingestion	3
Canonical metadata schema	3
Validation before processing	4
Storage and triggering	4
4. Stage 2 & 3 — Transcription, diarization, and role assignment	4
Assigning seller vs. customer roles	4
Known limitations to plan for	4
5. Stage 4 — Knowledge base from the sales books	4
6. Stage 5 — Rubric design	4
Example behavioral anchor	5
7. Stage 6 — Evaluation engine	5
Consistency measures	5
8. Stage 7 — Aggregation & dashboard	5
Data model	5
Dashboard views	5
9. Recommended technology stack	6
10. Risks and open questions	6
11. Suggested phased approach	6
